...
class Application(QMainWindow,QWidget):
    ...
    def initUI(self):
        ...
        self.FigureWidget.setGeometry(200,25,800,675)
        self.ButtonWidget.setGeometry(1025,25,150,625)
        self.InputWidget.setGeometry(1025,650,150,50)
        self.LabelButtonWidget.setGeometry(1050,650,100,120)
    ...
    def settingText(self,event,qp):
        ...
        if Imgtot == 0 :
            qp.drawText(300,750,'Image number / The total number of images')
        else:
            display_number = str(Imgnumber) + '/' + str(Imgtot) 
            qp.drawText(600,750,display_number)
